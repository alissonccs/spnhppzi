...
#include "stanExports_NHPP_COV_FRAT_06_07.h"

RCPP_MODULE(stan_fit4NHPP_COV_FRAT_06_07_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_NHPP_COV_FRAT_06_07")
