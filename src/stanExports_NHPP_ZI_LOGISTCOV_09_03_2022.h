...
namespace model_NHPP_ZI_LOGISTCOV_09_03_2022_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_NHPP_ZI_LOGISTCOV_09_03_2022");
    ...
    reader.add_event(19, 1, "restart", "model_NHPP_ZI_LOGISTCOV_09_03_2022");
    reader.add_event(252, 232, "end", "model_NHPP_ZI_LOGISTCOV_09_03_2022");
    return reader;
}
...
class model_NHPP_ZI_LOGISTCOV_09_03_2022
  : public stan::model::model_base_crtp<model_NHPP_ZI_LOGISTCOV_09_03_2022> {
private:
        int N;
        int n;
        int p;
        ...
        int tp_prior;
public:
    model_NHPP_ZI_LOGISTCOV_09_03_2022(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_NHPP_ZI_LOGISTCOV_09_03_2022_namespace::model_NHPP_ZI_LOGISTCOV_09_03_2022";
    ...
    ~model_NHPP_ZI_LOGISTCOV_09_03_2022() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_gt(p, 0))) {
                ...
                stan::math::assign(eta1, multiply(X, beta));
                current_statement_begin__ = 83;
                stan::math::assign(eta1_, elt_multiply(event, eta1));
            ...
            if (as_bool(logical_eq(p, 0))) {
                ...
                for (int i = 1; i <= n; ++i) {
                    ...
                    if (as_bool(logical_eq(get_base1(IndRec2, i, "IndRec2", 1), 0))) {
                        ...
                        stan::model::assign(log_lik1, 
                                    stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                    log_sum_exp(bernoulli_log(1, get_base1(omega, i, "omega", 1)), (get_base1(Lambda0, i, "Lambda0", 1) + bernoulli_log(0, get_base1(omega, i, "omega", 1)))), 
                                    "assigning variable log_lik1");
                    } else {
                        current_statement_begin__ = 124;
                        stan::model::assign(log_lik1, 
                                    stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                    ((bernoulli_log(0, get_base1(omega, i, "omega", 1)) + get_base1(Lambda0, i, "Lambda0", 1)) + get_base1(sum_log_lambda0, i, "sum_log_lambda0", 1)), 
                                    "assigning variable log_lik1");
                    }
                }
            } else {
                ...
                for (int i = 1; i <= n; ++i) {
                    ...
                    if (as_bool(logical_eq(get_base1(IndRec2, i, "IndRec2", 1), 0))) {
                        ...
                        stan::model::assign(log_lik1, 
                                    stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                    log_sum_exp(bernoulli_log(1, get_base1(omega, i, "omega", 1)), ((get_base1(Lambda0, i, "Lambda0", 1) * get_base1(exp_etay, i, "exp_etay", 1)) + bernoulli_log(0, get_base1(omega, i, "omega", 1)))), 
                                    "assigning variable log_lik1");
                    } else {
                        current_statement_begin__ = 137;
                        stan::model::assign(log_lik1, 
                                    stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                    (stan::model::rvalue(log_lik1, stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), "log_lik1") + (((bernoulli_log(0, get_base1(omega, i, "omega", 1)) + (get_base1(Lambda0, i, "Lambda0", 1) * get_base1(exp_etay, i, "exp_etay", 1))) + get_base1(sum_log_lambda0, i, "sum_log_lambda0", 1)) + get_base1(sum_eta1, i, "sum_eta1", 1))), 
                                    "assigning variable log_lik1");
                    }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_NHPP_ZI_LOGISTCOV_09_03_2022_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_NHPP_ZI_LOGISTCOV_09_03_2022";
    }
...
typedef model_NHPP_ZI_LOGISTCOV_09_03_2022_namespace::model_NHPP_ZI_LOGISTCOV_09_03_2022 stan_model;
#ifndef USING_R
