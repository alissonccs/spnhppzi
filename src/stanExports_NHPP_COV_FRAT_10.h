...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(19, 1, "restart", "model_NHPP_COV_FRAT_10");
    reader.add_event(132, 112, "end", "model_NHPP_COV_FRAT_10");
    return reader;
}
        ...
        try {
            ...
            for (int b = 1; b <= n; ++b) {
                ...
                stan::model::assign(sum_log_lambda0, 
                            ...
                            sum(stan::model::rvalue(log_lambda0_event, stan::model::cons_list(stan::model::index_min_max(get_base1(begin_int, b, "begin_int", 1), get_base1(end_int, b, "end_int", 1)), stan::model::nil_index_list()), "log_lambda0_event")), 
                ...
                if (as_bool(logical_gt(p, 0))) {
                    ...
                    stan::model::assign(sum_eta, 
                                stan::model::cons_list(stan::model::index_uni(b), stan::model::nil_index_list()), 
                                sum(stan::model::rvalue(eta_event, stan::model::cons_list(stan::model::index_min_max(get_base1(begin_int, b, "begin_int", 1), get_base1(end_int, b, "end_int", 1)), stan::model::nil_index_list()), "eta_event")), 
