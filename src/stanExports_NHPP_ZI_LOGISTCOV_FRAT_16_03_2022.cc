...
#include "stanExports_NHPP_ZI_LOGISTCOV_FRAT_16_03_2022.h"

RCPP_MODULE(stan_fit4NHPP_ZI_LOGISTCOV_FRAT_16_03_2022_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_NHPP_ZI_LOGISTCOV_FRAT_16_03_2022")
